...
def main():
    ...
    binary_signal, chunks, center_times, power, smoothed_power, times, threshold = convert2binary(data, rate, smoothing_window=3, percentage=args.percentage, otsu_threshold=args.otsu_threshold)
...
def interactive_mode(data, rate, args):
    ...
    def update(val):
        ...
        binary_signal, chunks, center_times, power, smoothed_power, times, threshold = convert2binary(
            data, rate, smoothing_window=3, percentage=pct, otsu_threshold=args.otsu_threshold)
